...
<body>
  ...
  setInterval(() => {
    ...
    <div id="wrapper">
        ...
        <b>ELEGANT BOUQUETS</b>
        </h2>
        <!-- Thông tin sản phẩm -->
        <div id="content">
            <div class="product"><img src="img/bo1.jpg" alt="Pink Spray Roses Bouquet"><h3>Pink Spray Roses Bouquet</h3><p>449.000đ</p><button class="add-to-cart" onclick="addToCart('Pink Spray Roses Bouquet', 449.000)">Thêm vào giỏ</button></div>
            <div class="product"><img src="img/bo2.jpg" alt="Blushing Charm"><h3>Blushing Charm</h3><p>349.000đ</p><button class="add-to-cart" onclick="addToCart('Blushing Charm', 349.000)">Thêm vào giỏ</button></div>
            <div class="product"><img src="img/bo3.jpg" alt="Pastel Symphony"><h3>Pastel Symphony</h3><p>499.000đ</p><button class="add-to-cart" onclick="addToCart('Pastel Symphony', 499.000)">Thêm vào giỏ</button></div>
            <div class="product"><img src="img/bo4.jpg" alt="Midnight Symphony"><h3>Midnight Symphony</h3><p>399.000đ</p><button class="add-to-cart" onclick="addToCart('Midnight Symphony', 399.000)">Thêm vào giỏ</button></div>
            <div class="product"><img src="img/bo5.jpg" alt="Lovely Whisper"><h3>Lovely Whisper</h3><p>599.000đ</p><button class="add-to-cart" onclick="addToCart('Lovely Whisper', 599.000)">Thêm vào giỏ</button></div>
            <div class="product"><img src="img/bo6.jpg" alt="Garden Melody"><h3>Garden Melody</h3><p>449.000đ</p><button class="add-to-cart" onclick="addToCart('Garden Melody', 449.000)">Thêm vào giỏ</button></div>
        </div>
        <div id="cart">
            <h2>Giỏ hàng</h2>
